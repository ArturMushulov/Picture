...
/* harmony import */ var _modules_checkTextUnputs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/checkTextUnputs */ "./src/js/modules/checkTextUnputs.js");
...
/* harmony import */ var _modules_drag_drop__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/drag&drop */ "./src/js/modules/drag&drop.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_checkTextUnputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="name"]');
  Object(_modules_checkTextUnputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="message"]');
...
var burger = function burger(menuSelector, burgerSelector) {
  ...
  burgerElem.addEventListener('click', function () {
    if (menuElem.style.display =  true && window.screen.availWidth < 993) {
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    if (sizeBlock.value == '' || materialBlock.value == '') {
      resultBlock.textContent = 'Введите данные';
...
/***/ "./src/js/modules/checkTextUnputs.js":
/*!*******************************************!*\
  !*** ./src/js/modules/checkTextUnputs.js ***!
  \*******************************************/
/*! exports provided: default */
...
var filter = function filter() {
  ...
  items.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      var classNameItem = '.' + btn.className;
      var itemTarget = document.querySelectorAll(classNameItem.replace(' animated fadeIn', ''));
      typeFilter(itemTarget);
...
var modals = function modals(state) {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var trigger = document.querySelectorAll(triggerSelector),
        ...
        scroll = Object(_scroll__WEBPACK_IMPORTED_MODULE_1__["default"])();
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  function createCards(responce) {
    responce.forEach(function (_ref) {
      var src = _ref.src,
          title = _ref.title,
          link = _ref.link;
